...
class CreateFreeShippingDiscountType extends TranslatorAwareType
{
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        ...
        $resolver->setDefaults([
            'label' => false,
            'form_theme' => '@PrestaShop/Admin/Sell/Catalog/Discount/create_free_shipping_form_theme.html.twig',
        ]);
    }
}
